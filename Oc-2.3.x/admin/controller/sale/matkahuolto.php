...
class ControllerSaleMatkahuolto extends Controller {
	...
	public function shipment() {
		$data = array();
		$data = array_merge($data,$this->load->language('sale/matkahuolto'));
	...
	public function getForm() {
		...
		if (isset($this->request->post['delivery_key'])) {
			$data['delivery_key'] = $this->request->post['delivery_key'];
		} else {
			$data['delivery_key'] = '';
		}
		...
		if (isset($this->request->post['goods'])) {
			$data['goods'] = $this->request->post['goods'];
		} else {
			$data['goods'] = '';
		}
		...
		if (isset($this->request->post['matkahuolto_ticket_sender_contact_name'])) {
			$data['matkahuolto_ticket_sender_contact_name'] = $this->request->post['matkahuolto_ticket_sender_contact_name'];
		} else {
			$data['matkahuolto_ticket_sender_contact_name'] = '';
		}

		if (isset($this->request->post['matkahuolto_ticket_sender_contact_number'])) {
			$data['matkahuolto_ticket_sender_contact_number'] = $this->request->post['matkahuolto_ticket_sender_contact_number'];
		} else {
			$data['matkahuolto_ticket_sender_contact_number'] = '';
		}
		...
		if (isset($this->request->post['matkahuolto_ticket_sender_reference'])) {
			$data['matkahuolto_ticket_sender_reference'] = $this->request->post['matkahuolto_ticket_sender_reference'];
		} else {
			$data['matkahuolto_ticket_sender_reference'] = '';
		}
		...
		if (isset($this->error['volume'])) {
			$data['error_volume'] = $this->error['volume'];
		} else {
			$data['error_volume'] = '';
		}
		...
		$data['action'] = $this->url->link('sale/matkahuolto/shipment', 'token=' . $this->session->data['token'] . '&order_id=' . $this->request->get['order_id'], true);
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('sale/matkahuolto', 'token=' . $this->session->data['token'] . '&order_id=' . $this->request->get['order_id'], true)
		);
		...
		if (isset($this->request->post['receiver_name'])) {
			...
			$data['receiver_name'] = $order_info['payment_firstname'] . ' ' . $order_info['payment_lastname'];
		}
		...
		if (isset($this->request->post['vak_description'])) {
			$data['vak_description'] = $this->request->post['vak_description'];
		} else {
			$data['vak_description'] = ''; 
		}
